/* homography.js: fit and apply a projective transform (a homography) from
   matched point pairs, so a "before" photograph can be warped onto the
   viewpoint of the "after" and the two laid exactly over each other.

   Adapted wholesale from MIRL Rephoto (js/homography.js); the mathematics is
   unchanged, only the namespace. Pure vanilla JS, no dependencies. A 3x3
   homography is a flat row-major array of nine numbers. */

window.AM = window.AM || {};

AM.Homography = (function () {
